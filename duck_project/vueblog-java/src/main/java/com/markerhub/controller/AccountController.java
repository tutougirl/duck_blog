...
public class AccountController {
    ...
    public Result regist(@Validated @RequestBody JSONObject jsonObject) {
        User us = jsonObject.toJavaObject(User.class);
        us.setPassword(SecureUtil.md5(us.getPassword()));
        boolean save = userService.save(us);
        return Result.fail("注册成功！",save);
    }
